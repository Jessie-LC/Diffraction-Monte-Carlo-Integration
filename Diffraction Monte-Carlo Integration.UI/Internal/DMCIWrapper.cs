...
internal class DMCIWrapper
{
    ...
    public static extern int ComputeDiffractionImageExport(int threadIDX, int wavelengthCount, bool squareScale, int size, int wavelengthIndex, float quality, float radius, float scale, float dist, float[] Irradiance, float[] Wavelength);
