...
internal class DMCIWrapper
{
    ...
    public static extern int ComputeDiffractionImageExport(int threadIDX, int streamCount, int wavelengthCount, bool squareScale, int size, int bladeCount, int wavelengthIndex, float quality, float radius, float scale, float dist, float[] Irradiance, float[] Wavelength);
